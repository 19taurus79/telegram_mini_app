...
export const LobMapper = () => {
  ...
  const autoRecognize = () => {
    ...
    const rules = [
      ...
      { lob: "Власне виробництво насіння", keywords: ["власн", "виробництв"] },
      { lob: "Міндобрива (основні)", keywords: ["селітр", "карбамід", "npk", "добрив", "амофос"] },
      { lob: "ЗЗР", keywords: ["гербіцид", "фунгіцид", "інсектицид", "раундап", "протруйник"] },
      { lob: "Позакореневi добрива", keywords: ["позакоренев", "мікродобрив"] },
    ];
