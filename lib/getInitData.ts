export function getInitData(): string {
  ...
  // Если включен режим принудительной браузерной аутентификации, всегда возвращаем пустую строку.
  if (forceBrowserAuth) {
    return "";
  }
  
  if (isDev) {
    // Возвращаем тестовые данные в режиме разработки (если не включен forceBrowserAuth)
    ...
    // Возврачае м реальные initData Telegram WebApp
